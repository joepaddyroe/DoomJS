...
export const POSS_STATES = {
  ...
  XDIE2: { sprite: 'POSS', frame: 13, tics: 5, action: 'A_Scream', next: 'XDIE3' },
...
export const TROO_STATES = {
  ...
  XDIE2: { sprite: 'TROO', frame: 14, tics: 5, action: 'A_Scream', next: 'XDIE3' },
...
export const BARREL_STATES = {
  ...
  BEXP4: { sprite: 'BEXP', frame: 3, tics: 10, action: null, next: 'BEXP5', fullbright: true },
